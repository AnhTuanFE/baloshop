import { faStar, faStarHalfAlt, faCircleChevronLeft, faCircleChevronRight } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className={clsx(styles.wrap_products)}>
                ...
                <div className={clsx(styles.wrap_product)}>
                    <div className={clsx(styles.wrap_image)}>
                        <img src="/images/vali1.jpg" alt="" className={clsx(styles.image_product)} />
                    </div>
